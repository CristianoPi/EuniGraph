...
class CoauthorshipGraphBuildModel(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "coauthorship_graph_build"
    __table_args__ = (
        Index("ix_coauthorship_graph_build_status", "status"),
        Index("ix_coauthorship_graph_build_active", "graph_type", "is_active"),
        Index("ix_coauthorship_graph_build_started_at", "started_at"),
    )
